...
class ServerRedis extends server_1.Server {
    ...
    bindEvents(subClient, pubClient) {
        ...
        subscribePatterns.forEach(pattern => {
            ...
            subClient.subscribe(isEventHandler ? pattern : this.getAckQueueName(pattern));
        });
    }
    close() {
    ...
    getPublisher(pub, pattern, id) {
        return (response) => {
            ...
            return pub.publish(this.getResQueueName(pattern), JSON.stringify(outgoingResponse));
        };
    }
