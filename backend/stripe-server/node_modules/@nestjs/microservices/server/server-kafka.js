...
class ServerKafka extends server_1.Server {
    constructor(options) {
        ...
        this.clientId =
            (clientOptions.clientId || constants_1.KAFKA_DEFAULT_CLIENT) + '-server';
        this.groupId = (consumerOptions.groupId || constants_1.KAFKA_DEFAULT_GROUP) + '-server';
    ...
    sendMessage(message, replyTopic, replyPartition, correlationId) {
