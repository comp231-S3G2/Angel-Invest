...
import { CustomTransportStrategy, PatternMetadata } from './interfaces';
...
export declare class ListenersController {
    ...
    registerPatternHandlers(instanceWrapper: InstanceWrapper<Controller>, server: Server & CustomTransportStrategy, moduleKey: string): void;
    ...
    createRequestScopedHandler(wrapper: InstanceWrapper, pattern: PatternMetadata, module: Module, moduleKey: string, methodKey: string, defaultCallMetadata?: Record<string, any>): (...args: unknown[]) => Promise<import("rxjs").Observable<any>>;
